...
//! FAT specification constants, signatures, and cluster limits.

pub mod boot_code;

pub const FAT_OEM_NAME: &[u8; 8] = b"RIMFAT  "; // BS_OEMName
...
pub const FAT_TRANSACTION_SECTOR: u64 = 12; // RimFAT: Transaction log / Dirty bit (Moved from 2 to avoid conflict with standard boot record)
...
pub const FAT_SIGNATURE: u16 = 0xAA55;
pub const FAT_FS_TYPE_32: &[u8; 8] = b"FAT32   ";
pub const FAT_FS_TYPE_16: &[u8; 8] = b"FAT16   ";
pub const FAT_FS_TYPE_12: &[u8; 8] = b"FAT12   ";
pub const FAT_FS_TYPE_UNKNOWN: &[u8; 8] = b"FAT     ";
...
// FAT Limits
pub const FAT12_MAX_CLUSTERS: u32 = 4084; // Microsoft Spec: Count < 4085
pub const FAT16_MAX_CLUSTERS: u32 = 65524; // Microsoft Spec: Count < 65525
pub const FAT8_MAX_CLUSTERS: u32 = 254; // Informal: 8-bit entries (256 - reserved)
