...
pub const EXFAT_CLUSTER_SIZE: u32 = 32768;
pub const EXFAT_SECTORS_PER_CLUSTER: u8 = (EXFAT_CLUSTER_SIZE / EXFAT_SECTOR_SIZE as u32) as u8;
pub const EXFAT_RESERVED_SECTORS: u16 = 128;
...
pub const EXFAT_EOC: u32 = 0xFFFFFFF;
...
pub const EXFAT_ENTRY_UPCASE_TABLE: u8 = 0x82;
...
pub const EXFAT_END_OF_DIR: u8 = 0x00;
...
pub const EXFAT_UPCASE_TABLE_SIZE: usize = 5836;
pub const EXFAT_UPCASE_CHECKSUM: u32 = 0xE619D30D;

pub const EXFAT_UPCASE_TABLE: [u8; EXFAT_UPCASE_TABLE_SIZE] = [
