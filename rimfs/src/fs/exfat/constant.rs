...
pub const EXFAT_UPCASE_MINIMAL_LENGTH: usize = 60;

/// Minimal upcase table (ASCII-only, compressed)
pub const EXFAT_UPCASE_MINIMAL: [u8; EXFAT_UPCASE_MINIMAL_LENGTH] = [
    // identity: U+0000..U+0060 (length 0x0061)
    0xFF, 0xFF, 0x61, 0x00, // A..Z (26 words)
    ...
    0x59, 0x00, 0x5A, 0x00, // identity U+007B..U+FFFF (length 0xFF85)
    0xFF, 0xFF, 0x85, 0xFF,
];

/// from: [exfatprogs] `https://github.com/exfatprogs/exfatprogs`
pub const EXFAT_UPCASE_FULL_CHECKSUM: u32 = 0xE619D30D;
pub const EXFAT_UPCASE_FULL_LENGTH: usize = 5836;

/// from: [exfatprogs] `https://github.com/exfatprogs/exfatprogs`
pub const EXFAT_UPCASE_FULL: [u8; EXFAT_UPCASE_FULL_LENGTH] = [
